...
#include "speech_interfaces/srv/detail/speak__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const speech_interfaces::srv::Speak_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  speech_interfaces::srv::Speak_Request & ros_message)
{
  // Member: text
  cdr >> ros_message.text;
...
{
  auto typed_message =
    static_cast<const speech_interfaces::srv::Speak_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<speech_interfaces::srv::Speak_Request *>(
    untyped_ros_message);
...
{
  return &speech_interfaces::srv::typesupport_fastrtps_cpp::_Speak_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, speech_interfaces, srv, Speak_Request)() {
  return &speech_interfaces::srv::typesupport_fastrtps_cpp::_Speak_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_speech_interfaces
cdr_serialize(
  const speech_interfaces::srv::Speak_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  speech_interfaces::srv::Speak_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = speech_interfaces::srv::Speak_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const speech_interfaces::srv::Speak_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<speech_interfaces::srv::Speak_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &speech_interfaces::srv::typesupport_fastrtps_cpp::_Speak_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, speech_interfaces, srv, Speak_Response)() {
  return &speech_interfaces::srv::typesupport_fastrtps_cpp::_Speak_Response__handle;
}
...
// functions for speech_interfaces::srv::Speak_Request already declared above

// functions for speech_interfaces::srv::Speak_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_speech_interfaces
cdr_serialize(
  const speech_interfaces::srv::Speak_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  speech_interfaces::srv::Speak_Event & ros_message)
{
  // Member: info
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        speech_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_Speak_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        speech_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_Speak_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = speech_interfaces::srv::Speak_Event;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        speech_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_Speak_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        speech_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_Speak_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const speech_interfaces::srv::Speak_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<speech_interfaces::srv::Speak_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Speak_Event__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const speech_interfaces::srv::Speak_Event *>(
...
static size_t _Speak_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Speak_Event(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _Speak_Event__callbacks = {
  "speech_interfaces::srv",
  "Speak_Event",
...
static rosidl_message_type_support_t _Speak_Event__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_Speak_Event__callbacks,
  get_message_typesupport_handle_function,
...
{
  return &speech_interfaces::srv::typesupport_fastrtps_cpp::_Speak_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, speech_interfaces, srv, Speak_Event)() {
  return &speech_interfaces::srv::typesupport_fastrtps_cpp::_Speak_Event__handle;
}
...
static const rosidl_service_type_support_t _Speak__handle{
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_Speak__callbacks,
  get_service_typesupport_handle_function,
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<speech_interfaces::srv::Speak_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<speech_interfaces::srv::Speak_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<speech_interfaces::srv::Speak_Event>(),
...
{
  return &speech_interfaces::srv::typesupport_fastrtps_cpp::_Speak__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, speech_interfaces, srv, Speak)() {
  return &speech_interfaces::srv::typesupport_fastrtps_cpp::_Speak__handle;
}
