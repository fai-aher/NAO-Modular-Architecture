...
class DetectObjects_Response(metaclass=Metaclass_DetectObjects_Response):
    ...
    _fields_and_field_types = {
        ...
        'object_poses': 'sequence<geometry_msgs/Pose>',
    }
    ...
    def __init__(self, **kwargs):
        ...
        self.object_poses = kwargs.get('object_poses', [])
    ...
    def __eq__(self, other):
        ...
        if self.object_names != other.object_names:
            return False
        if self.object_poses != other.object_poses:
            return False
        return True
    ...
    def object_poses(self):
        """Message field 'object_poses'."""
        return self._object_poses

    @object_poses.setter
    def object_poses(self, value):
        if self._check_fields:
            from geometry_msgs.msg import Pose
            from collections.abc import Sequence
            from collections.abc import Set
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'object_poses' field must be a set or sequence and each value of type 'Pose'"
        self._object_poses = value
...
class DetectObjects_Event(metaclass=Metaclass_DetectObjects_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<perception_interfaces/DetectObjects_Request, 1>',
        'response': 'sequence<perception_interfaces/DetectObjects_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['perception_interfaces', 'srv'], 'DetectObjects_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['perception_interfaces', 'srv'], 'DetectObjects_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from perception_interfaces.srv import DetectObjects_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
    ...
    def response(self, value):
        if self._check_fields:
            from perception_interfaces.srv import DetectObjects_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_DetectObjects(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from perception_interfaces.srv import _detect_objects
...
class DetectObjects(metaclass=Metaclass_DetectObjects):
    from perception_interfaces.srv._detect_objects import DetectObjects_Request as Request
    from perception_interfaces.srv._detect_objects import DetectObjects_Response as Response
    from perception_interfaces.srv._detect_objects import DetectObjects_Event as Event
