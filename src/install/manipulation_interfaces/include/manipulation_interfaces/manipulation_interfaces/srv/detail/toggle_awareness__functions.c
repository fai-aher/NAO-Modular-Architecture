...
manipulation_interfaces__srv__ToggleAwareness_Request__create(void)
{
  ...
  manipulation_interfaces__srv__ToggleAwareness_Request * msg = (manipulation_interfaces__srv__ToggleAwareness_Request *)allocator.allocate(sizeof(manipulation_interfaces__srv__ToggleAwareness_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(manipulation_interfaces__srv__ToggleAwareness_Request));
  bool success = manipulation_interfaces__srv__ToggleAwareness_Request__init(msg);
  if (!success) {
...
manipulation_interfaces__srv__ToggleAwareness_Request__destroy(manipulation_interfaces__srv__ToggleAwareness_Request * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    manipulation_interfaces__srv__ToggleAwareness_Request__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
manipulation_interfaces__srv__ToggleAwareness_Request__Sequence__init(manipulation_interfaces__srv__ToggleAwareness_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  manipulation_interfaces__srv__ToggleAwareness_Request * data = NULL;

  if (size) {
    data = (manipulation_interfaces__srv__ToggleAwareness_Request *)allocator.zero_allocate(size, sizeof(manipulation_interfaces__srv__ToggleAwareness_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = manipulation_interfaces__srv__ToggleAwareness_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        manipulation_interfaces__srv__ToggleAwareness_Request__fini(&data[i - 1]);
      }
...
manipulation_interfaces__srv__ToggleAwareness_Request__Sequence__fini(manipulation_interfaces__srv__ToggleAwareness_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      manipulation_interfaces__srv__ToggleAwareness_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  manipulation_interfaces__srv__ToggleAwareness_Request__Sequence * array = (manipulation_interfaces__srv__ToggleAwareness_Request__Sequence *)allocator.allocate(sizeof(manipulation_interfaces__srv__ToggleAwareness_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = manipulation_interfaces__srv__ToggleAwareness_Request__Sequence__init(array, size);
  if (!success) {
...
manipulation_interfaces__srv__ToggleAwareness_Request__Sequence__destroy(manipulation_interfaces__srv__ToggleAwareness_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    manipulation_interfaces__srv__ToggleAwareness_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
manipulation_interfaces__srv__ToggleAwareness_Request__Sequence__are_equal(const manipulation_interfaces__srv__ToggleAwareness_Request__Sequence * lhs, const manipulation_interfaces__srv__ToggleAwareness_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!manipulation_interfaces__srv__ToggleAwareness_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  manipulation_interfaces__srv__ToggleAwareness_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(manipulation_interfaces__srv__ToggleAwareness_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    manipulation_interfaces__srv__ToggleAwareness_Request * data =
      (manipulation_interfaces__srv__ToggleAwareness_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!manipulation_interfaces__srv__ToggleAwareness_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          manipulation_interfaces__srv__ToggleAwareness_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!manipulation_interfaces__srv__ToggleAwareness_Request__copy(
...
manipulation_interfaces__srv__ToggleAwareness_Response__init(manipulation_interfaces__srv__ToggleAwareness_Response * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->message)) {
    manipulation_interfaces__srv__ToggleAwareness_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  manipulation_interfaces__srv__ToggleAwareness_Response * msg = (manipulation_interfaces__srv__ToggleAwareness_Response *)allocator.allocate(sizeof(manipulation_interfaces__srv__ToggleAwareness_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(manipulation_interfaces__srv__ToggleAwareness_Response));
  bool success = manipulation_interfaces__srv__ToggleAwareness_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
manipulation_interfaces__srv__ToggleAwareness_Response__Sequence__init(manipulation_interfaces__srv__ToggleAwareness_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  manipulation_interfaces__srv__ToggleAwareness_Response * data = NULL;

  if (size) {
    data = (manipulation_interfaces__srv__ToggleAwareness_Response *)allocator.zero_allocate(size, sizeof(manipulation_interfaces__srv__ToggleAwareness_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = manipulation_interfaces__srv__ToggleAwareness_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        manipulation_interfaces__srv__ToggleAwareness_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
manipulation_interfaces__srv__ToggleAwareness_Response__Sequence__fini(manipulation_interfaces__srv__ToggleAwareness_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      manipulation_interfaces__srv__ToggleAwareness_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  manipulation_interfaces__srv__ToggleAwareness_Response__Sequence * array = (manipulation_interfaces__srv__ToggleAwareness_Response__Sequence *)allocator.allocate(sizeof(manipulation_interfaces__srv__ToggleAwareness_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = manipulation_interfaces__srv__ToggleAwareness_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
manipulation_interfaces__srv__ToggleAwareness_Response__Sequence__destroy(manipulation_interfaces__srv__ToggleAwareness_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    manipulation_interfaces__srv__ToggleAwareness_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
manipulation_interfaces__srv__ToggleAwareness_Response__Sequence__are_equal(const manipulation_interfaces__srv__ToggleAwareness_Response__Sequence * lhs, const manipulation_interfaces__srv__ToggleAwareness_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!manipulation_interfaces__srv__ToggleAwareness_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  manipulation_interfaces__srv__ToggleAwareness_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(manipulation_interfaces__srv__ToggleAwareness_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    manipulation_interfaces__srv__ToggleAwareness_Response * data =
      (manipulation_interfaces__srv__ToggleAwareness_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!manipulation_interfaces__srv__ToggleAwareness_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          manipulation_interfaces__srv__ToggleAwareness_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!manipulation_interfaces__srv__ToggleAwareness_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
manipulation_interfaces__srv__ToggleAwareness_Event__init(manipulation_interfaces__srv__ToggleAwareness_Event * msg)
{
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    manipulation_interfaces__srv__ToggleAwareness_Event__fini(msg);
    return false;
  }
  // request
  if (!manipulation_interfaces__srv__ToggleAwareness_Request__Sequence__init(&msg->request, 0)) {
    manipulation_interfaces__srv__ToggleAwareness_Event__fini(msg);
    return false;
  }
  // response
  if (!manipulation_interfaces__srv__ToggleAwareness_Response__Sequence__init(&msg->response, 0)) {
    manipulation_interfaces__srv__ToggleAwareness_Event__fini(msg);
    return false;
  }
  return true;
...
manipulation_interfaces__srv__ToggleAwareness_Event__fini(manipulation_interfaces__srv__ToggleAwareness_Event * msg)
{
  ...
  // request
  manipulation_interfaces__srv__ToggleAwareness_Request__Sequence__fini(&msg->request);
  // response
  manipulation_interfaces__srv__ToggleAwareness_Response__Sequence__fini(&msg->response);
}
...
manipulation_interfaces__srv__ToggleAwareness_Event__are_equal(const manipulation_interfaces__srv__ToggleAwareness_Event * lhs, const manipulation_interfaces__srv__ToggleAwareness_Event * rhs)
{
  ...
  // request
  if (!manipulation_interfaces__srv__ToggleAwareness_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!manipulation_interfaces__srv__ToggleAwareness_Response__Sequence__are_equal(
  ...
  manipulation_interfaces__srv__ToggleAwareness_Event * output)
{
  ...
  // request
  if (!manipulation_interfaces__srv__ToggleAwareness_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!manipulation_interfaces__srv__ToggleAwareness_Response__Sequence__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  manipulation_interfaces__srv__ToggleAwareness_Event * msg = (manipulation_interfaces__srv__ToggleAwareness_Event *)allocator.allocate(sizeof(manipulation_interfaces__srv__ToggleAwareness_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(manipulation_interfaces__srv__ToggleAwareness_Event));
  bool success = manipulation_interfaces__srv__ToggleAwareness_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
manipulation_interfaces__srv__ToggleAwareness_Event__Sequence__init(manipulation_interfaces__srv__ToggleAwareness_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  manipulation_interfaces__srv__ToggleAwareness_Event * data = NULL;

  if (size) {
    data = (manipulation_interfaces__srv__ToggleAwareness_Event *)allocator.zero_allocate(size, sizeof(manipulation_interfaces__srv__ToggleAwareness_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = manipulation_interfaces__srv__ToggleAwareness_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        manipulation_interfaces__srv__ToggleAwareness_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
manipulation_interfaces__srv__ToggleAwareness_Event__Sequence__fini(manipulation_interfaces__srv__ToggleAwareness_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      manipulation_interfaces__srv__ToggleAwareness_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  manipulation_interfaces__srv__ToggleAwareness_Event__Sequence * array = (manipulation_interfaces__srv__ToggleAwareness_Event__Sequence *)allocator.allocate(sizeof(manipulation_interfaces__srv__ToggleAwareness_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = manipulation_interfaces__srv__ToggleAwareness_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
manipulation_interfaces__srv__ToggleAwareness_Event__Sequence__destroy(manipulation_interfaces__srv__ToggleAwareness_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    manipulation_interfaces__srv__ToggleAwareness_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
manipulation_interfaces__srv__ToggleAwareness_Event__Sequence__are_equal(const manipulation_interfaces__srv__ToggleAwareness_Event__Sequence * lhs, const manipulation_interfaces__srv__ToggleAwareness_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!manipulation_interfaces__srv__ToggleAwareness_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  manipulation_interfaces__srv__ToggleAwareness_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(manipulation_interfaces__srv__ToggleAwareness_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    manipulation_interfaces__srv__ToggleAwareness_Event * data =
      (manipulation_interfaces__srv__ToggleAwareness_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!manipulation_interfaces__srv__ToggleAwareness_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          manipulation_interfaces__srv__ToggleAwareness_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!manipulation_interfaces__srv__ToggleAwareness_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
