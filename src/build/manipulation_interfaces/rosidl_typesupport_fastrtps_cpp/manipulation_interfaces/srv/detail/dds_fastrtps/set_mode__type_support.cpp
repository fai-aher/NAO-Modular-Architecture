...
#include "manipulation_interfaces/srv/detail/set_mode__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const manipulation_interfaces::srv::SetMode_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  manipulation_interfaces::srv::SetMode_Request & ros_message)
{
  // Member: mode
  cdr >> ros_message.mode;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = manipulation_interfaces::srv::SetMode_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const manipulation_interfaces::srv::SetMode_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<manipulation_interfaces::srv::SetMode_Request *>(
    untyped_ros_message);
...
{
  return &manipulation_interfaces::srv::typesupport_fastrtps_cpp::_SetMode_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, manipulation_interfaces, srv, SetMode_Request)() {
  return &manipulation_interfaces::srv::typesupport_fastrtps_cpp::_SetMode_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_manipulation_interfaces
cdr_serialize(
  const manipulation_interfaces::srv::SetMode_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  manipulation_interfaces::srv::SetMode_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = manipulation_interfaces::srv::SetMode_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const manipulation_interfaces::srv::SetMode_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<manipulation_interfaces::srv::SetMode_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &manipulation_interfaces::srv::typesupport_fastrtps_cpp::_SetMode_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, manipulation_interfaces, srv, SetMode_Response)() {
  return &manipulation_interfaces::srv::typesupport_fastrtps_cpp::_SetMode_Response__handle;
}
...
// functions for manipulation_interfaces::srv::SetMode_Request already declared above

// functions for manipulation_interfaces::srv::SetMode_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_manipulation_interfaces
cdr_serialize(
  const manipulation_interfaces::srv::SetMode_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  manipulation_interfaces::srv::SetMode_Event & ros_message)
{
  // Member: info
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        manipulation_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_SetMode_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        manipulation_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_SetMode_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = manipulation_interfaces::srv::SetMode_Event;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        manipulation_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_SetMode_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        manipulation_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_SetMode_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const manipulation_interfaces::srv::SetMode_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<manipulation_interfaces::srv::SetMode_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &manipulation_interfaces::srv::typesupport_fastrtps_cpp::_SetMode_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, manipulation_interfaces, srv, SetMode_Event)() {
  return &manipulation_interfaces::srv::typesupport_fastrtps_cpp::_SetMode_Event__handle;
}
...
static const rosidl_service_type_support_t _SetMode__handle{
  ...
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<manipulation_interfaces::srv::SetMode_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<manipulation_interfaces::srv::SetMode_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<manipulation_interfaces::srv::SetMode_Event>(),
...
{
  return &manipulation_interfaces::srv::typesupport_fastrtps_cpp::_SetMode__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, manipulation_interfaces, srv, SetMode)() {
  return &manipulation_interfaces::srv::typesupport_fastrtps_cpp::_SetMode__handle;
}
